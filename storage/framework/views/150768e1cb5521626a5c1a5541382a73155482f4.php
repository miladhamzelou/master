                    ...
                    <div class="pr15 pl15 ptop0">
                        <div class="right floated">
                            <div class="fontsize1 semi-bold mt2" style="line-height:24px;">
                                <a href="<?php echo e(url('Region-Restaurant-List/'.str_replace(' ','-',trim($currentCity['name'])).'/'.str_replace(' ','-',trim($region['name'])).'/'.str_replace(' ','-',$cat['title']))); ?>"><?php echo e($cat['title']); ?></a>
                            </div>
