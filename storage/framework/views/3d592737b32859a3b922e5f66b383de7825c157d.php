                    ...
                    <div class="pr15 pl15 ptop0">
                        <div class="right floated">
                            <div class="fontsize1 semi-bold mt2" style="line-height:24px;">
                                <a href="<?php echo e(url('Neighbourhood-Restaurant-List/'.str_replace(' ','-',trim($currentCity['name'])).'/'.str_replace(' ','-',trim($region['name'])).'/'.str_replace(' ','-',trim($neighbourhood['name'])).'/'.str_replace(' ','-',$cat['title']))); ?>"><?php echo e($cat['title']); ?></a>
                            </div>
                            <a href="<?php echo e(url('restaurant-list/'.$currentCity['id'])); ?>"><div class="grey-text"><?php echo e($currentCity['name']); ?></div></a>
                        </div>
                        <div class="left floated">
                            <img src="<?php echo e(asset('images/restaurant-type/'. ($cat['img'] ? $cat['img'] : 'default.png'))); ?>" style="height: 44px; display: inline;" class="">
                        </div>
                    </div>
                    <div class="clear"></div>
