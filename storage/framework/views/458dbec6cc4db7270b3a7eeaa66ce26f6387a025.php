<?php $__env->startSection('content'); ?>
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans(lcfirst(config('app.controller')) . '.' . config('app.controller') )); ?></h3>
            <div class="box-tools pull-right">
<?php /*                <a href="<?php echo e(url(getCurrentURL('controller')).'/create'); ?>" title="<?php echo e(trans('public.create new entity')); ?>" class="btn-box-tool pull-left"><i class="fa fa-plus"></i></a>*/ ?>
                ...
                <a href="<?php echo e(url(getCurrentURL('controller').'/searchForm')); ?>" class="btn btn-box-tool pull-left" data-status="close" onclick="Admin.search(this, event)" title="<?php echo e(trans('public.search entity')); ?>"><i class="fa fa-search"></i></a>
