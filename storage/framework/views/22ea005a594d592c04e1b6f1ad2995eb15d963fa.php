        ...
        <div id="mainframe" class="wrapper">
            ...
            <div class="row">
                <div class="col-l-16">
                    <div class="row">
                        <div class="mt10">
                            <?php echo $__env->make('restaurantBundle.region.sidebar-left', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('restaurantBundle.region.list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('restaurantBundle.region.sidebar-right', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
