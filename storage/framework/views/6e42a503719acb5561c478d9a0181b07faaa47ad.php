...
<?php /*                        <a href="<?php echo e(url(getCurrentURL('controller').'/destroy/' . $value['id'] )); ?>"  onclick="Admin.delete(this,event)"><span class="fa fa fa-trash-o"></span></a>*/ ?>
                        <a href="<?php echo e(url(getCurrentURL('controller').'/show/' . $value['id'] )); ?>"  onclick="Admin.show(this, event)"><span class="fa fa-tv"></span></a>
                        <a href="<?php echo e(url(getCurrentURL('controller').'/edit/' . $value['id'] )); ?>"><span class="fa fa-pencil"></span></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
