                    ...
                    <?php foreach(ftArray(config('app.bundle'), lcfirst(config('app.controller')) , 'list') as $cnf): ?>
                        <?php if(!@$cnf['show_page']): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                <td><a onclick="Admin.changeEnum(this, event)" data-field="is_closed" data-status="<?php echo e($value['is_closed']); ?>" href="<?php echo e(url(getCurrentURL('controller').'/changeEnum/' . $value['id'])); ?>"><span class="fa <?php if($value['is_closed'] == 0): ?> fa-check-circle text-success <?php else: ?> fa-minus-circle text-danger <?php endif; ?>"></span></a></td>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
