...
<head>
    ...
    <title>
        <?php /*<?php if(config('app.controller')): ?>*/ ?>
            <?php /*<?php echo e(trans('public.Administrator')); ?> :: <?php echo e(trans(lcfirst(config('app.controller')).'.'.config('app.title'))); ?>*/ ?>
        <?php /*<?php elseif(config('app.prefix') == 'Admin'): ?> ::*/ ?>
            <?php /*<?php if(@Auth::user()->info()['name']): ?><?php echo e(@Auth::user()->info()['name'] .' '.@Auth::user()->info()['family']); ?> <?php else: ?> <?php echo e(@Auth::user()->info()['username']); ?> <?php endif; ?>*/ ?>
        <?php /*<?php endif; ?>*/ ?>
    </title>
