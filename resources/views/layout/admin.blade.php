...
<head>
    ...
    <meta name="url" content="{{ getCurrentURL('action') }}">
    ...
    @section('stylesheets')
        ...
        <link rel="stylesheet" href="{{ asset('assets/tools/jquery-ui/jquery-ui.min.css') }}">
    ...
    @section('javascript')
        ...
        <script src="{{ asset('assets/tools/jquery-ui/jquery-ui.min.js') }}"></script>
